...
typedef struct bt_matching_ctx {
    ...
    uint64_t             book_checksum;   /* V11: aggregate book state checksum */
...
/* V11: Get aggregate checksum of all order books in this shard */
uint64_t bt_matching_checksum(const bt_matching_ctx_t *ctx);
